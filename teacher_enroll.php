  ...
  <!-- / Navbar -->
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <h4 class="fw-bold py-3 mb-4"> Teacher Enroll </h4>
                ...
                <div class="col-xl">
                  <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      <h5 class="mb-0">Teacher Detail</h5>
                      <small class="text-muted float-end"></small>
                    </div>

                    <div class="card-body">
                        <div class="mb-3">
                          <label class="form-label" for="basic-default-fullname">TEACHER ID</label>
                          <input type="text" class="form-control" id="basic-default-fullname" name="t1" placeholder="TEACHER ID" required>
                        </div>
                        <?php
$id=$_GET['id'];
...
?>  
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" id="basic-default-fullname" value="<?php echo $row['department'] ?>" name="t4" placeholder="DEPARTMENT" required>
                        </div>
                        <?php
}
?>
                        ...
                        <div class="mb-3">
                       <a href="view_teacher_active.php?id=<?php echo$id;?>"> <button type="submit" class="btn btn-primary" name="sbt" >Submit</button></a>
                        </div>
...
if(isset($_POST['sbt']))
{
   ...
   $added_on=date("Y/m/d H:i:s");
    mysqli_query($con,"insert into stu_enroll(enroll_no,name,email_id,department,year,type,status,teacher_id,added_on)values('$t1','$t2','$t3','$t4','$t5','$t6','0','$id','$added_on')");
    echo"<script>alert('Recorde Added Successfully');
    window.location = 'view_teacher_active.php';
    </script>
    ";
