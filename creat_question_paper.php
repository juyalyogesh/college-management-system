              ...
              <div class="row">
                <div class="col-xl-6">
                  <div class="card mb-4">
                    ...
                    <div class="mb-3">
                          <label class="form-label" for="basic-icon-default-fullname">Select Course</label>
                          ...
                          <option value="BSC(ZBC)">BSC(ZBC)</option>
                        ...
                        <div class="mb-3">
                          ...
                          <div class="input-group input-group-merge">
                          <select id="defaultSelect" name="t4" class="form-select">
...
if ($uploadOk == 0) {
  ...
  {
    mysqli_query($con,"insert into question_paper_pdf(course_name,sem,subject,year,pdf_url)values('$t1','$t2','$t3','$t4','$target_file')");
