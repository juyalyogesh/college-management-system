                ...
                <div class="col-xl-6">
                  <div class="card mb-4">
                    ...
                    <div class="mb-3">
                          ...
                          <input type="text" class="form-control" id="basic-default-fullname" name="t1" placeholder="Subject" required>
                        </div>
                      
                        
                        <div class="mb-3">
                          <label class="form-label" for="basic-default-fullname">Paper Type</label>
                          <input type="text" class="form-control" id="basic-default-fullname" name="t2" placeholder="Paper Type" required>
                        </div>
                        <div class="mb-3">
...
if ($uploadOk == 0) {
  ...
  {
    mysqli_query($con,"insert into admin_question_paper(subject,paper_type,added_on,photo)values('$t1','$t2','$added_on','$target_file')");
