...
?>
  ...
  <option value="Data Structures">Data Structures</option>
                    ...
                    <div class="mb-3">
                          <label class="form-label" for="basic-default-fullname">Upload Vedio Details</label>
                          <input type="text" class="form-control" id="basic-default-fullname" name="t2" placeholder="Upload Vedio Details" required="">
                        </div>
...
if ($uploadOk == 0) {
  ...
  {
    mysqli_query($con,"insert into student_vedio(department,details,pdf_url)values('$t1','$t2','$target_file')");
    echo"<script>alert('Added successfully');
    window.location = 'teacher_upload_vedio.php';
    </script>
    ";
  } else {
