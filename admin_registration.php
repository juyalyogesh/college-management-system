  ...
  <!-- / Navbar -->
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <h4 class="fw-bold py-3 mb-4"> New Admin Ragister  </h4>
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" id="basic-default-fullname" name="t1" placeholder="Admin Name" required>
                        </div>
                        <div class="mb-3">
...
if(isset($_POST['sbt']))
{
    ...
    $query=mysqli_query($con,"select * from admin_recorde where email_id='$t5'");
...
if ($uploadOk == 0) {
  ...
  {
    mysqli_query($con,"insert into  admin_recorde(name,father_name,mother_name,mobile_number,email_id,Date_of_birth,address,added_on,photo)values('$t1','$t2','$t3','$t4','$t5','$t6','$t7','$added_on','$target_file')");
    echo"<script>alert('Recorde Added Successfully');
    window.location = 'admin_recorde.php';
    </script>
    ";
