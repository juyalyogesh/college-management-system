  ...
  <!-- / Navbar -->
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <h4 class="fw-bold py-3 mb-4"> Website Appoiments !  </h4>
...
<?php  
$mquery=mysqli_query($con,"select * from appointment");
...
<TD>
                         <div class="dropdown">
                            ...
                            <div class="dropdown-menu" style="">
                              <a class="dropdown-item" href="Appoiment.php?id=<?php echo $row['A_id'];?>"><i class="bx bx-trash me-1"></i> Delete</a>
                            </div>
                          </div>
                         </TD>
</tr>
