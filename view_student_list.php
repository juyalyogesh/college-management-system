      ...
      <div class="layout-container">
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="card">
                <h5 class="card-header">Ragister Student List</h5>
...
while($row=mysqli_fetch_array($mquery))
{
  ...
  //isme pehle wale table ka ek data dusre wale se match karwana ya dusre wale ke sath usse connect karwane ke liye line number 106 ka use kiya.
  $en_no=$row['enroll_no'];
...
<TD>
                         <div class="dropdown">
                            ...
                            <div class="dropdown-menu" style="">
                              <a class="dropdown-item" href="view_student_list_delete.php?id=<?php echo $row['enroll_no'];?>"><i class="bx bx-trash me-1"></i> Delete</a>
                            </div>
                          </div>
                         </TD>
</td>
