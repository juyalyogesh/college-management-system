...
if(isset($_POST['sbt']))
{
    ...
    $t6=$_POST['t6'];
    $t7=$_POST['t7'];
    mysqli_query($con,"update admin_recorde set name='$t1',father_name='$t2',mother_name='$t3',mobile_number='$t4',email_id='$t5',Date_of_birth='$t6',address='$t7' where a_id='$id'");
    echo" data update";
