...
>
              ...
              <div class="row">
                <div class="col-xl">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                          <label class="form-label" for="basic-default-fullname">Student Name</label>
                          <input type="text" class="form-control" id="basic-default-fullname" name="t1" placeholder="Student Name" required>
                        </div>
                        <div class="mb-3">
  ...
  <option value="BTECH MACHANICAL">BTECH MACHANICAL</option>
...
if(isset($_POST['sbt']))
{
    ...
    $query=mysqli_query($con,"select * from student_record where email='$t5'");
    $count=mysqli_num_rows($query);

    if($count>0){
echo"<script>alert('Email Already Ragister')</script>";
    }
    else if(validateEmail($t5)){
...
if ($uploadOk == 0) {
  ...
  {
    mysqli_query($con,"insert into  student_record(student_name,father_name,mother_name,mobile_number,email,dob,address,section,added_on,photo)values('$t1','$t2','$t3','$t4','$t5','$t6','$t7','$t8','$added_on','$target_file')");
    echo"<script>alert('Recorde Added Successfully');
    window.location = 'student_recorde.php';
    </script>
    ";
