            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="row">
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" id="basic-default-fullname" name="t1" placeholder="Course Name" required>
                        </div>
                        <div class="mb-3">
                          <label class="form-label" for="basic-default-fullname">About Course </label>
                          <input type="text" class="form-control" id="basic-default-fullname" name="t2" placeholder="About Course " required>
                        </div>
                        <div class="mb-3">
                          <label class="form-label" for="basic-default-fullname">Durection Course</label>
                          <input type="number" class="form-control" id="basic-default-fullname" name="t3" placeholder="Durection Course" required>
                        </div>
                ...
                <div class="col-xl-12">
                  <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      <h5 class="mb-0">Show Update Course</h5>
                      <small class="text-muted float-end"></small>
                    </div>
...
// if everything is ok, try to upload file
  ...
  {
    mysqli_query($con,"insert into website_course(Course,About_Course,Durection,photo,added_on)values('$t1','$t2','$t3','$target_file','$added_on')");
